/*
  ...
  - You are about to drop the `wharehouse` table. If the table is not empty, all the data it contains will be lost.
...
CREATE TABLE "new_product_warehouse" (
    ...
    CONSTRAINT "product_warehouse_warehouseId_fkey" FOREIGN KEY ("warehouseId") REFERENCES "warehouses" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
